...
{
    public class LandInformationSearchApiTest: IClassFixture<InternalWebApplicationFactory<Startup>>
    {
        private readonly InternalWebApplicationFactory<Startup> _factory;

        public LandInformationSearchApiTest(InternalWebApplicationFactory<Startup> factory)
        {
            _factory = factory;
        ...
        {
            // Arrange
            AddRequiredCurrentFlaStatus(application, FellingLicenceStatus.WoodlandOfficerReview);
        ...
        public async Task WhenFileStorageDoesNotSucceed_ReturnsInternalServerErrorStatusCode(FellingLicenceApplication application)
        {
            ...
            _factory.AddDocumentServiceMock.Verify(x => x.AddDocumentsAsInternalUserAsync(
                It.Is<AddDocumentsRequest>(r =>
                                                ...
                                                && r.DocumentPurpose == DocumentPurpose.FcLisConstraintReport),

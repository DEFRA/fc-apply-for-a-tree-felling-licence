...
public class CompleteConfirmedFellingAndRestockingTests : WoodlandOfficerReviewUseCaseTestsBase<Web.Services.FellingLicenceApplication.WoodlandOfficerReview.WoodlandOfficerReviewUseCase>
{
    [Theory, AutoMoqData]
    public async Task CompleteConfirmedFellingAndRestocking_WhenServiceReturnsError(
        Guid applicationId,
        Guid userId,
        string error)
    {
        ...
        // Act
        var result = await sut.CompleteConfirmedFellingAndRestockingDetailsAsync(applicationId, user, CancellationToken.None);
    ...
    [Theory, AutoMoqData]
    public async Task CompleteConfirmedFellingAndRestocking_WhenServiceReturnsSuccess(
        Guid applicationId,
        Guid userId)
    {
        // Arrange

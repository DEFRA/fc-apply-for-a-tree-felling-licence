...
public partial class ForesterServicesTests
{
    ...
    [Theory, AutoData]
    public async Task GenerateCompartmentImageAsync_ReturnsNoExtent(string applicationReference)
    {
        ShapeDetails.ShapeGeometry = new Polygon();

        var sut = CreateSUT();
        var result =
            await sut.GenerateImage_SingleCompartmentAsync(applicationReference, ShapeDetails, CancellationToken.None, 100,
                MapGeneration.Other, "");
    ...
    [Theory, AutoData]
    public async Task GenerateCompartmentImageAsync_PostQueryWithConversionAsyncFails(string applicationReference)
    {
    ...
    [Theory, AutoData]
    public async Task GenerateCompartmentImageAsync_GetImageFails(string applicationReference)
    {
    ...
    [Theory, AutoData]
    public async Task GenerateCompartmentImageAsync_CheckJobStatusFails(string applicationReference)
    {
    ...
    [Theory, AutoData]
    public async Task GenerateCompartmentImageAsync_CheckStatusFails(string applicationReference)
    {

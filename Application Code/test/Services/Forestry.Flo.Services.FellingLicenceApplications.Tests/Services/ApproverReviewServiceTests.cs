...
using Xunit;
using ApproverReview = Forestry.Flo.Services.FellingLicenceApplications.Entities.ApproverReview;
...
public class ApproverReviewServiceTests
{
    ...
    public async Task GetWhenNoApproverReviewExistsYet(Guid applicationId)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetApproverReviewAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
    ...
    public async Task GetWhenApproverReviewExists(Guid applicationId, ApproverReview approverReview)
    {
        ...
        Assert.Equal(approverReview.ReferToLocalAuthorityReason, result.Value.ReferToLocalAuthorityReason);
        Assert.Equal(approverReview.ApplicationRefusedReason, result.Value.ApplicationRefusedReason);
        ...
        Guid userId)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetStatusHistoryForApplicationAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.VerifyNoOtherCalls();
    }
        ...
        Guid userId)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetStatusHistoryForApplicationAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetAssigneeHistoryForApplicationAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.VerifyNoOtherCalls();
    }
        ...
        Guid userId)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(x => x.AddOrUpdateApproverReviewAsync(It.Is<ApproverReview>(ar =>
            ...
            && ar.ReferToLocalAuthorityReason == model.ReferToLocalAuthorityReason
            && ar.ApplicationRefusedReason == model.ApplicationRefusedReason
        ...
        Guid userId)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetApproverReviewAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.Verify(
            x => x.AddOrUpdateApproverReviewAsync(existingReview, It.IsAny<CancellationToken>()), Times.Once);
        ...
        Assert.Equal(model.ReferToLocalAuthorityReason, existingReview.ReferToLocalAuthorityReason);
        Assert.Equal(model.ApplicationRefusedReason, existingReview.ApplicationRefusedReason);
    ...
    public async Task DeleteApproverReviewWhenDeleteFails(Guid applicationId, ApproverReview existingEntity)
    {
        ...
        _fellingLicenceApplicationRepository.Verify(
            x => x.GetApproverReviewAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.Verify(
            x => x.DeleteApproverReviewAsync(applicationId, It.IsAny<CancellationToken>()), Times.Once);
        _fellingLicenceApplicationRepository.VerifyNoOtherCalls();
    }

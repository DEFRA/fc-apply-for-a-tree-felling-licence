...
public class UpdateWoodlandOfficerReviewServiceUpdateConditionalStatusTests
{
    ...
    public UpdateWoodlandOfficerReviewServiceUpdateConditionalStatusTests()
    {
        _fellingLicenceApplicationRepository = new InternalUserContextFlaRepository(_context);
    }

    [Fact]
    public async Task UpdateConditionalStatusAsync_Succeeds_UpdatesFields()
    {
        var sut = CreateSut();
    ...
    [Fact]
    public async Task UpdateConditionalStatusAsync_Fails_WhenUserNotAssigned()
    {
        var sut = CreateSut();
        var woodlandOfficerId = Guid.NewGuid();
        var fla = CreateFellingLicenceApplication(woodlandOfficerId);
        ...
        var model = new ConditionsStatusModel { IsConditional = true };

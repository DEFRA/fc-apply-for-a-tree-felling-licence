...
import { AccordionAppearance, AccordionSelectionMode, RequestedItem } from "./components/accordion/interfaces";
...
export namespace Components {
    ...
    interface CalciteDropdownGroup {
        ...
        "scale": Scale;
        /**
          * specify the selection mode - multiple (allow any number of (or no) active items), single (allow and require one active item), none (no active items), defaults to single
         */

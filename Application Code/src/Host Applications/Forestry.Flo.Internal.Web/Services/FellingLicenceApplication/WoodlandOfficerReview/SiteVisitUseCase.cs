...
public class SiteVisitUseCase : FellingLicenceApplicationUseCaseBase, ISiteVisitUseCase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var fellingImage = await GetImageForFellingAndRestockingCompartments(
            ...
            summaryInfo.Value.OsGridReference,
            summaryInfo.Value.NearestTown,
        ...
        CancellationToken cancellationToken)
    {
        var generatedMainFellingMap = await _foresterServices
            .GenerateImage_MultipleCompartmentsAsync(applicationReference, osGridReference, nearestTown, shapes, cancellationToken, 3000);

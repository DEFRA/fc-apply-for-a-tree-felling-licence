...
public class AmendConfirmedFellingDetailsViewModelValidator : AbstractValidator<AmendConfirmedFellingDetailsViewModel>
{
    public AmendConfirmedFellingDetailsViewModelValidator()
    {
        RuleFor(m => m.ConfirmedFellingRestockingDetails)
            .SetValidator(new IndividualConfirmedFellingRestockingDetailModelValidator());

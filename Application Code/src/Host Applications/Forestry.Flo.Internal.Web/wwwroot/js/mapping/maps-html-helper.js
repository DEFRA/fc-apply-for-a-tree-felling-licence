define(["require", "exports"], function (require, exports) {
    ...
    var HTMLHelper = /** @class */ (function () {
        ...
        HTMLHelper.getViewString = function (fieldName) {
        ...
        HTMLHelper.getCompartments = function (name) {
            if (name === undefined || name === null || name === "both") {
                name = "";
            }
            var resx = [];
            var _this = this;
            var items = document.querySelectorAll(`[data-group="compartments_GIS"]${name === "" ? "" :`[data-type="${name}"]` }`);

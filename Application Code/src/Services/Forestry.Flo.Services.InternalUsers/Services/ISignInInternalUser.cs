...
public interface ISignInInternalUser
{
    /// <summary>
    ...
    /// <summary>
    /// Generate a <see cref="ClaimsIdentity"/> representing the given <see cref="UserAccount"/>.
    /// </summary>
    ...
    ClaimsIdentity CreateClaimsIdentityFromUserAccount(UserAccount userAccount);
}
...
/// <summary>
/// Model class for data to merge into a InformFcStaffOfApplicationRefusal notification.
/// </summary>
public class InformFcStaffOfApplicationRefusalDataModel : IApplicationNotification
{
    /// <summary>
    ...
    /// <summary>
    /// Gets and sets the name of the individual whom refused the application.
    /// </summary>
    public string? RefusedByName { get; set; }

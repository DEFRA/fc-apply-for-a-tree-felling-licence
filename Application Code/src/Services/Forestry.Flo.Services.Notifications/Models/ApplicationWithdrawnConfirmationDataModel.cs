...
/// <summary>
/// Model class for data to merge into an ApplicationWithdrawnConfirmation notification.
/// </summary>

public class ApplicationWithdrawnConfirmationDataModel : IApplicationNotification
{
    /// <summary>

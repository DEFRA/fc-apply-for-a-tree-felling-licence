...
{
    /// <summary>
    /// Provides list of applications for sending the notification to the applicants and woodland owner that the threshold has passed and automatic withdrawal has happend
    /// </summary> 

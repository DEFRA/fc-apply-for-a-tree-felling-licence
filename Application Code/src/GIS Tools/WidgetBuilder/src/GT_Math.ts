import GT_OSGB from "./GT_OSGB";
import GT_WGS84 from "./GT_WGS84";

class GT_Math {
    public static E_N_to_Lat(
        East: any,
        North: any,
        a: any,
        b: any,
    ...
    public static Iterate_XYZ_to_Lat(
        a: any,
        e2: any,
        PHI1: any,
        Z: any,
    ...
    public static XYZ_to_Long(X: any, Y: any) {
    ...
    public static Lat_Long_to_East(
        PHI: any,
        LAM: any,
        a: any,
        b: any,
    ...
    public static Lat_Long_to_North(
        PHI: any,
        LAM: any,
        a: any,
        b: any,
    ...
    public static WGS84_To_OSGB(item: GT_WGS84) {
    ...
    public static OSGB_To_WGS84(item: GT_OSGB) {
        var height = 0;
        ...
        return new GT_WGS84(latitude, longitude);
    };
}
